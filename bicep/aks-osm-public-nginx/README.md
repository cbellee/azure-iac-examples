...
## NGINX Ingress (public IP) <-mTLS-> Open Service Mesh 

A demonstration of how to configure a secure ingress path to two pods/services running in AKS as part of an OSM service mesh.
