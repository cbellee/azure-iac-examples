...
resource NodeRecordingRulesRuleGroup_aks_zone_zfs_test 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  location: 'australiaeast'
  name: 'NodeRecordingRulesRuleGroup-aks-zone-zfs-test'
  properties: {
    description: 'Node Recording Rules RuleGroup'
    enabled: true
    scopes: [
      '/subscriptions/b2375b5f-8dab-4436-b87c-32bc7fdce5d0/resourcegroups/aks-zone-zfs-test-rg/providers/Microsoft.monitor/accounts/defaultazuremonitorworkspace-eau'
    ]
    interval: 'PT1M'
    clusterName: 'aks-zone-zfs-test'
    rules: [
      {
...
resource KubernetesRecordingRulesRuleGroup_aks_zone_zfs_test 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  location: 'australiaeast'
  name: 'KubernetesRecordingRulesRuleGroup-aks-zone-zfs-test'
  properties: {
...
resource NodeRecordingRulesRuleGroup_Win_aks_zone_zfs_test 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  location: 'australiaeast'
  name: 'NodeRecordingRulesRuleGroup-Win-aks-zone-zfs-test'
  properties: {
...
resource NodeAndKubernetesRecordingRulesRuleGroup_Win_aks_zone_zfs_test 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  location: 'australiaeast'
  name: 'NodeAndKubernetesRecordingRulesRuleGroup-Win-aks-zone-zfs-test'
  properties: {
